  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto space-y-16 pb-20">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.3em] text-zinc-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-2 group relative overflow-hidden rounded-[3.5rem] border border-[#1f1f22] p-12 transition-all hover:bg-[#18181b] bg-[#121214]">
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex items-end justify-between mt-16">
              <span className="text-[10px] font-black tracking-[0.2em] uppercase text-zinc-700">ACTIVE PROTOCOL: GPT-4O</span>
        ...
        <div className="group relative overflow-hidden rounded-[3rem] border border-[#1f1f22] p-10 transition-all bg-[#121214] hover:bg-[#18181b]">
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="mt-12">
              <span className="text-[10px] font-black tracking-[0.2em] uppercase text-[#34d399] bg-[#34d399]/10 px-4 py-2 rounded-full border border-[#34d399]/20">READY FOR UPLOAD</span>
            </div>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-[3rem] border border-[#1f1f22] p-10 transition-all bg-[#121214] hover:bg-[#18181b]">
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="mt-12">
              <span className="text-[10px] font-black tracking-[0.2em] uppercase text-[#fbbf24] bg-[#fbbf24]/10 px-4 py-2 rounded-full border border-[#fbbf24]/20">3 MODES AVAILABLE</span>
            </div>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-[3rem] border border-[#1f1f22] p-10 transition-all bg-[#121214] hover:bg-[#18181b]">
          <div className="space-y-8">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-zinc-800/30 border border-white/5 shadow-inner">
              <FileSearch size={24} className="text-[#52525b]" />
            </div>
            <div className="space-y-4">
          ...
          <div className="mt-12">
            <span className="text-[10px] font-black tracking-[0.2em] uppercase text-zinc-800">ATS COMPLIANT</span>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-[3rem] border border-[#1f1f22] p-10 transition-all bg-[#121214] hover:bg-[#18181b]">
          ...
          <div className="mt-12">
            <span className="text-[10px] font-black tracking-[0.2em] uppercase text-[#34d399] bg-[#34d399]/10 px-4 py-2 rounded-full border border-[#34d399]/20">GENERATE NOW</span>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 group relative overflow-hidden rounded-[3.5rem] border border-[#1f1f22] p-12 transition-all bg-[#121214]">
          <div className="flex flex-col h-full gap-8">
            <div className="flex items-center justify-between">
              <h3 className="text-[11px] font-black tracking-[0.3em] uppercase text-zinc-700">LEARNING VELOCITY</h3>
            ...
            <div className="flex items-center justify-between pt-8 border-t border-[#1f1f22]">
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-zinc-700 uppercase tracking-[0.2em] font-black">Session time this week</p>
              </div>
              <div className="text-right space-y-1">
                <p className="text-3xl font-black text-[#34d399] tracking-tight">+24%</p>
                <p className="text-[11px] text-zinc-700 uppercase tracking-[0.2em] font-black">Efficiency growth</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-12">
          <div className="flex items-center gap-4 group cursor-pointer">
             <Clock className="text-[#a87ffb]" size={36} />
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center justify-between p-8 rounded-[3rem] bg-[#121214] border border-[#1f1f22] transition hover:bg-[#18181b] hover:border-zinc-800 shadow-lg group">
                <div className="flex items-center gap-10">
                  <div className="w-16 h-16 rounded-[1.5rem] flex items-center justify-center bg-[#18181b] border border-white/5 group-hover:bg-black transition-colors duration-500">
                    <item.icon size={28} className="text-zinc-600 group-hover:text-[#a87ffb] transition duration-500" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="text-[20px] font-black text-white tracking-tight leading-none">{item.name}</h4>
                    <p className="text-[14px] text-zinc-600 font-bold leading-none">{item.sub}</p>
                  </div>
                </div>
                <div className="flex items-center gap-8 text-zinc-700">
                  {i === 1 ? <ArrowUpRight size={24} className="hover:text-white transition cursor-pointer" /> : (i === 2 ? <Eye size={24} className="hover:text-white transition cursor-pointer" /> : <>
                    <Download size={24} className="hover:text-white transition cursor-pointer" />
                    <Share2 size={24} className="hover:text-white transition cursor-pointer" />
                  </>)}
                </div>
              </div>
            ))}
        ...
        <div className="lg:col-span-4 space-y-12">
          <div className="space-y-8">
            <h2 className="text-3xl font-black text-white tracking-tight">Archive Insights</h2>
            <div className="rounded-[3.5rem] border border-[#1f1f22] p-12 space-y-10 relative overflow-hidden bg-[#121214] group shadow-inner">
              ...
              <p className="text-[20px] leading-[1.6] italic text-zinc-400 font-bold">
          ...
          <div className="p-12 rounded-[3.5rem] border border-[#1f1f22] bg-[#121214] space-y-10 shadow-lg relative overflow-hidden">
            <div className="space-y-2">
              <h4 className="text-[12px] font-black uppercase tracking-[0.3em] text-zinc-600">YOUR ARCHIVE SPACE</h4>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="h-3 w-full bg-[#18181b] rounded-full overflow-hidden shadow-inner">
            ...
            <button className="w-full h-16 text-[12px] font-black uppercase tracking-[0.3em] border border-[#1f1f22] rounded-3xl transition hover:bg-white/5 text-zinc-500 active:scale-95 duration-200">
              Manage Storage
            </button>
          </div>
        </div>
      ...
      <footer className="pt-24 pb-12 flex items-center justify-between border-t border-[#1f1f22]">
        <div className="flex items-center gap-14 text-[11px] font-black uppercase tracking-[0.4em] text-zinc-800">
